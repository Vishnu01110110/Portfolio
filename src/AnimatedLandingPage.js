  ...
  const AnimatedLandingPage = ({ navHeight = 0, onSectionChange }) => {
    ...
    useEffect(() => {
      ...
      // Create a single IntersectionObserver for all sections
      const observer = new IntersectionObserver(
        (entries) => {
          entries.forEach((entry) => {
            ...
            // Update active section when more than 50% visible
        ...
        { 
          threshold: [0, 0.5, 1],
          rootMargin: '-10% 0px -10% 0px' // Add some margin to improve transition timing
        }
      );
    ...
    const renderTechIcon = () => {
      ...
      return (
        <div className="relative w-32 h-32 md:w-64 md:h-64 flex items-center justify-start md:justify-center pl-4 md:pl-0">
          {icons[activeIcon]}
    ...
    return (
      <div style={{ height: `calc((var(--vh, 1vh) * 100) - ${navHeight}px)` }} className="overflow-y-auto snap-y snap-mandatory">
        {/* Hero Section */}
        <section 
          id="hero" 
          style={{ height: `calc((var(--vh, 1vh) * 100) - ${navHeight}px)` }}
          className={`overflow-hidden flex items-center justify-center bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-900 dark:to-gray-800 transition-all duration-700 snap-start snap-always ${
            isIntersecting.hero ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-10'
          }`}
        >
        ...
        <section 
          id="about" 
          style={{ height: `calc((var(--vh, 1vh) * 100) - ${navHeight}px)` }}
          className={`overflow-hidden flex items-center justify-center bg-white dark:bg-gray-800 transition-all duration-700 snap-start snap-always ${
            ...
            <div className="flex flex-col items-center gap-4 md:gap-6">
              <div className="relative w-24 h-24 md:w-40 md:h-40">
                ...
                <img 
                  ...
                  alt="Profile" 
                  className={`rounded-full w-24 h-24 md:w-40 md:h-40 object-cover transition-opacity duration-300 ${
        ...
        {/* Skills and Projects sections keep the same structure but update transition classes */}
        <section 
          id="skills" 
          style={{ height: `calc((var(--vh, 1vh) * 100) - ${navHeight}px)` }}
          className={`overflow-hidden flex items-center justify-center bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-900 dark:to-gray-800 transition-all duration-700 snap-start snap-always ${
